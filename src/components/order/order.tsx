...
export const Order = () => {
	return (
		<div className="order sm:mt-[45px] sm:pt-[60px] pt-[76px]" id="order">
			<div className="container">
				<div className="small-lg:bg-pink rounded-[0.7rem] md:rounded-[6rem]">
					<div className="relative small-lg:bg-black-pink white-bg w-full rounded-br-[5rem] small-lg:pl-[60px] small-lg:pt-[77px] small-lg:pb-[84px] small-lg:pr-[99px] rounded-[0.75rem] md:rounded-br-[15rem] ">
						...
						<form className="small-lg:bg-transparent bg-black-pink flex small-lg:flex-row flex-col small-lg:gap-[80px] gap-11 small-lg:items-end items-start pt-[60px] pb-[94px] pl-[30px] pr-[30px] small-lg:p-0 rounded-[15px]">
							...
							<input type="submit" value='Отправить' className="btn small-lg:mb-[44px] cursor-pointer w-fit" />
						</form>
					</div>
				</div>
			</div>
