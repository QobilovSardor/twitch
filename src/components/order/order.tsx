			...
			<div className="container">
				<div className="pink-box small-lg:bg-pink rounded-[0.7rem] md:rounded-[6rem]">
					<div className="form-box relative small-lg:bg-black-pink w-full rounded-br-[5rem] small-lg:pl-[60px] small-lg:pt-[77px] small-lg:pb-[79px] small-lg:pr-[99px] rounded-[0.75rem] md:rounded-br-[15rem] ">
						<h3 className="relative text-2xl small-lg:mb-[52px] mb-[76px] small-lg:text-white text-gray font-2MASS-J1808 uppercase dark-text ml-[10px]">Введите свои контактные данные и мы с Вами свяжемся</h3>
						<form className="small-lg:bg-transparent bg-black-pink flex small-lg:flex-row flex-col small-lg:gap-[80px] gap-11 small-lg:items-end items-start pt-[60px] pb-[94px] pl-[30px] pr-[30px] small-lg:p-0 rounded-[15px]">
							<div className="small-lg:w-[560px] w-full">
								<div className="flex sm:gap-[40px] gap-8 sm:flex-row flex-col">
									<input className="dark-input rounded-md w-full h-[60px] sm:pl-[27px] pl-[32px]" type="text" name="name" placeholder="Введите имя" />
									<input className="dark-input rounded-md w-full h-[60px] sm:pl-[27px] pl-[32px]" type="email" name="email" placeholder="Введите почту" />
								</div>
							...
							<button type="submit" className="btn sm:w-[344px] small-lg:mb-[49px] tracking-[4px] cursor-pointer w-full">Отправить</button>
						</form>
					</div>
				</div>
			</div>
