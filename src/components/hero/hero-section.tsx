		...
		<div className="hero-section md:pb-[265px] pb-[295px] relative z-10">
			<div className="container relative">
				...
				<div className="md:pt-[95px] pt-[34px] md:mb-[95px] mb-[232px] text-white font-normal md:text-left text-center">
					...
					<p className="text-2xl leading-[118.5%] md:mt-[30px] md:mb-20 sm:mb-[347px] mb-[352px] mt-[30px] tracking-[1px] md:w-auto w-[309px] md:mx-0 mx-auto">Увеличим вашу аудиторию в разы!</p>
