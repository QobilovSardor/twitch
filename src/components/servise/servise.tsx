	...
	<div className="service mt-[-40px] z-40 relative flex small-lg:flex-row flex-col mb-40 w-[1440px] mx-auto" id="servise">
		...
		<div className="container flex justify-between mx-0 text-gray font-normal">
			<div className="service-content max-w-[576px] ml-[99px] mt-5">
				<h3 className="text-[57px] font-2MASS-J1808 uppercase leading-[100%] white-text mb-[48px] sm:mt-auto mt-[-214px] ml-[13px] title-text">О сервисе</h3>
				<p className="text-lg sm:leading-[40px] light ml-[13px] sm:mt-auto mt-[63px] leading-[63px]">Каковы преимущества работы с нами? Предлагаем уникальные возможности для значительного увеличения аудитории вашего канала на Twitch. Наш личный кабинет поможет вам привлечь больше зрителей, увеличить количество просмотров и получить новых подписчиков.</p>
