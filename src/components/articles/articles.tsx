	...
	return (
		<div className="articles" id="articles">
			<div className="container">
				<h2 className="title-text">статьи</h2>

				<div className="articles-boxes flex flex-wrap gap-[43px] mt-[60px]">

					<div className='relative h-[413px] small-lg:w-[657px] w-[100%] bg-black-pink pink-card rounded-[6rem]'>
					...
					<div className='relative h-[413px] bg-black-pink pink-card rounded-[6rem] small-lg:w-[460px]'>
